    ...
    namespace tuyapiphp;
        ...
        Class Devices
        {
            ...
            [
                ...
                'post_timer'         => '/v1.0/devices/{device_id}/timers',
                'get_timers'         => '/v1.0/devices/{device_id}/timers',
                'put_timer'          => '/v1.0/devices/{device_id}/timers/{timer_id}',
                'delete_timer'       => '/v1.0/devices/{device_id}/timers/{timer_id}'
            ];
        }
